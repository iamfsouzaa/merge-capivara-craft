      ...
      <div className="container mx-auto">
        ...
        <header className="text-center mb-12 md:mb-16 px-4 relative">
          <img 
            src={sparkles} 
            alt="" 
            className="absolute -top-4 -left-4 md:left-8 w-10 md:w-14 opacity-80"
            aria-hidden="true"
          />
          <img 
            src={sparkles} 
            alt="" 
            className="absolute -top-2 -right-4 md:right-8 w-8 md:w-12 opacity-70 rotate-45"
            aria-hidden="true"
          />
        ...
        <footer className="mt-20 text-center pb-16 relative">
          <img 
            src={sparkles} 
            alt="" 
            className="absolute top-0 left-1/4 w-8 md:w-10 opacity-60"
            aria-hidden="true"
          />
          <img 
            src={sparkles} 
            alt="" 
            className="absolute -top-2 right-1/4 w-6 md:w-8 opacity-50 -rotate-12"
            aria-hidden="true"
          />
